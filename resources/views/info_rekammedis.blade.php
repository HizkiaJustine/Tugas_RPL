        ...
        <table class="min-w-full divide-y divide-gray-200" id="Table">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white-500 uppercase tracking-wider">Hasil Konsultasi</th>
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white-500 uppercase tracking-wider">Rumah Sakit Rujukan</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($rekamMedis as $rekamMedis)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $rekamMedis['HasilKonsultasi'] }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $rekamMedis['RumahSakitRujukan'] }}</td>
